...
IMAGE img_peashooter_selector_background_left;       // 选角界面朝向向左的豌豆射手背景图片
IMAGE img_peashooter_selector_background_right;      // 选角界面朝向向右的豌豆射手背景图片
IMAGE img_sunflower_selector_background_left;        // 选角界面朝向向左的向日葵背景图片
IMAGE img_sunflower_selector_background_right;       // 选角界面朝向向右的向日葵背景图片
...
Atlas atlas_peashooter_run_left;                     // 豌豆射手朝向左的跑动动画图集
Atlas atlas_peashooter_run_right;                    // 豌豆射手朝向右的跑动动画图集
...
{
	AddFontResourceEx(_T("resources/TPix.ttf"), FR_PRIVATE, NULL);
	...
	loadimage(&img_selector_tip, _T("resources/selector_backgound.png"));
	...
	loadimage(&img_1P_selector_btn_down_right, _T("resources/2P_selector_btn_down.png"));
	flip_image(&img_1P_selector_btn_down_right, &img_1P_selector_btn_down_left);

	loadimage(&img_peashooter_selector_background_right, _T("resources/peashooter_selector_background"));
	...
	mciSendString(_T("open resources/bgm_game.mp3 alias bgm_game"), NULL, 0, NULL);// alias 指令给他们定义别名
